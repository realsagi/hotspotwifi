...
public class WifihotspotAboutBox extends javax.swing.JDialog {

    public WifihotspotAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wifihotspot.WifihotspotApp.class).getContext().getResourceMap(WifihotspotAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wifihotspot.WifihotspotApp.class).getContext().getActionMap(WifihotspotAboutBox.class, this);
